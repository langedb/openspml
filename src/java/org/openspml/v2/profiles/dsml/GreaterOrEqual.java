 ...
 * From the DSML spec...
 * <p/>
 * <pre> &lt;xsd:element name="greaterOrEqual" type="AttributeValueAssertion"/&gt; </pre>
 */
public class GreaterOrEqual extends AttributeValueAssertion {

    private static final String code_id = "$Id: GreaterOrEqual.java,v 1.7 2006/06/29 22:31:46 kas Exp $";

    public GreaterOrEqual() { ; }

    protected void toXML(XmlBuffer buffer)
            throws DSMLProfileException {
        super.toXML("greaterOrEqual", buffer);
    }

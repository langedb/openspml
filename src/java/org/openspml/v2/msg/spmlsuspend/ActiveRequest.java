 ...
 *         Date: Feb 15, 2006
 */
public class ActiveRequest extends BasicRequest {

    private static final String code_id = "$Id: ActiveRequest.java,v 1.4 2006/04/25 21:22:09 kas Exp $";

    public ActiveRequest() { ; }

    public ActiveRequest(String requestId,

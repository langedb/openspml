 ...
 *         Date: Feb 16, 2006
 */
public class Query extends SearchQuery {

    private static final String code_id = "$Id: Query.java,v 1.3 2006/04/25 21:22:09 kas Exp $";
    ...
    public Query(QueryClause[] queryClauses,
                 ...
                 String targetID,
                 Scope scope) {
        super(queryClauses, basePsoID, targetID, scope);
    }

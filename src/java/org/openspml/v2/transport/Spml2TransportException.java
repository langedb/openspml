...
public class Spml2TransportException extends Exception {
    ...
    public Spml2TransportException(String message) {
        super(message);
    }

    public Spml2TransportException(Throwable cause) {
        super(cause);
    }

    public Spml2TransportException(String message, Throwable cause) {
        super(message, cause);
    }
}
